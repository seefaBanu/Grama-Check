...
service /general on new http:Listener(9091) {
    ...
    resource function post user/certificate(NewCertificateRequest certificateRequest) returns http:InternalServerError & |http:Created & readonly|http:Conflict & readonly {
